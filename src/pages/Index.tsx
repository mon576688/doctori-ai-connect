...
import { MessageCircle, Search, BookOpen, Heart, Shield, Users, Stethoscope, Brain, Activity, Clock, Star, CheckCircle, Globe, Smartphone, Calendar, FileText, Target, TrendingUp, Award, Lightbulb, ChevronRight, Phone, Mail, MapPin, Languages, ThumbsUp, Eye, Zap, Calculator, Bell, Quote } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-hero py-20 px-4 overflow-hidden">
        ...
        <div className="floating-shape w-96 h-96 bg-secondary/20 -bottom-32 -right-32" style={{ animationDelay: '2s' }} />
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <img src={heroImage} alt="Doctori AI Health Assistant" className="rounded-2xl shadow-float w-full animate-float" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              <Card className="card-glass card-hover-lift text-center relative z-10">
                <CardContent className="p-8">
                  ...
                  <div className="bg-secondary text-secondary-foreground w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-bold">2</div>
              ...
              <Card className="card-glass card-hover-lift text-center relative z-10">
                <CardContent className="p-8">
                  ...
                  <div className="bg-accent text-accent-foreground w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-bold">3</div>
          ...
          <div className="section-box section-box-gradient">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {[
                ...
                <Card key={doctor.id} className="bg-background/80 backdrop-blur-sm card-hover-lift border-2 border-transparent hover:border-primary/20">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="flex items-center justify-center space-x-1 mb-3">
                      ...
                      <span className="text-sm text-muted-foreground">{doctor.rating} ({doctor.reviews} reviews)</span>
                    </div>
              ...
              {[
                ...
                <Link key={index} to="/chat">
                  <Card className="bg-background/80 backdrop-blur-sm card-hover-lift cursor-pointer h-full group">
                    <CardContent className="p-6 text-center">
                      <div className={`bg-gradient-to-br ${category.gradient} p-4 rounded-2xl w-16 h-16 mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-20 px-4">
        <div className="container max-w-4xl mx-auto">
          <div className="rounded-3xl bg-gradient-hero p-12 lg:p-16 text-center relative overflow-hidden">
            ...
            <div className="floating-shape w-24 h-24 bg-secondary/30 bottom-10 right-20" style={{ animationDelay: '1s' }} />
